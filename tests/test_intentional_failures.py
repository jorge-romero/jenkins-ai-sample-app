...
except ModuleNotFoundError: pass  # This will raise ImportError
...
def test_attribute_error():
    ...
    my_dict = {"key1": "value1"}
    try:
    result = my_dict.nonexistent_attribute
except AttributeError: pass  # Dicts don't have this attribute
